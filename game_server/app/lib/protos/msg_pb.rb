...
module Protocol
  ...
  AwardItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("protocol.AwardItem").msgclass
  ...
  S2C_LoadEnd = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("protocol.S2C_LoadEnd").msgclass
